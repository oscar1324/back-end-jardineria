...
CREATE TABLE `authorities` (
  ...
  CONSTRAINT `username_Auth` FOREIGN KEY (`username`) REFERENCES `users` (`username`)
...
INSERT INTO `users` VALUES ('Alba_Muri','oiujklg','1','Alba','Muriel','Calle almendros'),('Ingelmo_Avenida','ligadeCera','0','Marcos','Ingelmo','Calle las canteras'),('oscar_bichito','oiujkl123','0','Oscar','izquierdo','Calle Santa Claus');
